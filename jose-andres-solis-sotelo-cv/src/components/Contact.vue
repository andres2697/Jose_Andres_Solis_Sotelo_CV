    ...
    <div class="w-full mx-4">
      <div class="w-full flex flex-col space-y-4">
        <div class="w-full flex justify-between mt-4">
          <div class="w-[30%]"><span>Teléfono: (744) 501-4744</span></div>
          <div class="w-[40%]"><span>Correo: andressol296@gmail.com</span></div>
          <div class="w-[30%]"><span>Dirección: México, CDMX</span></div>
        </div>
        <div class="flex flex-col w-100%">
          <span>Redes Sociales:</span>
          <div class="w-fit flex mx-5">
            <a
              v-for="(socialNetwork, index) in socialNetworks" :key="index" 
